...
public class BitacoraDTO {
	...
	public Boolean getActualizaCct() {
		return actualizaCct;
	}

	public void setActualizaCct(Boolean actualizaCct) {
		this.actualizaCct = actualizaCct;
	}

	public String getCctAnterior() {
		return cctAnterior;
	}

	public void setCctAnterior(String cctAnterior) {
	...
	public void setActualizaNombre(Boolean actualizaNombre) {
		this.actualizaNombre = actualizaNombre;
	}

	public String getNombreCctAnterior() {
		return nombreCctAnterior;
	}
	...
	public Boolean getActualizaCalle() {
		return actualizaCalle;
	}

	public void setActualizaCalle(Boolean actualizaCalle) {
		this.actualizaCalle = actualizaCalle;
	}

	public String getCalleCctAnterior() {
		return calleCctAnterior;
	}

	public void setCalleCctAnterior(String calleCctAnterior) {
	...
	public void setActualizaColonia(Boolean actualizaColonia) {
		this.actualizaColonia = actualizaColonia;
	}

	public String getColoniaCctAnterior() {
		return coloniaCctAnterior;
	}
	...
	public Boolean getActualizaCodigoPostal() {
		return actualizaCodigoPostal;
	}

	public void setActualizaCodigoPostal(Boolean actualizaCodigoPostal) {
		this.actualizaCodigoPostal = actualizaCodigoPostal;
	}

	public String getCodigoPostalCctAnterior() {
		return codigoPostalCctAnterior;
	}

	public void setCodigoPostalCctAnterior(String codigoPostalCctAnterior) {
	...
	public void setActualizaAlcaldia(Boolean actualizaAlcaldia) {
		this.actualizaAlcaldia = actualizaAlcaldia;
	}

	public Long getIdAlcaldiaCctAnterior() {
		return idAlcaldiaCctAnterior;
	}
	...
	public Boolean getActualizaTurno() {
		return actualizaTurno;
	}

	public void setActualizaTurno(Boolean actualizaTurno) {
		this.actualizaTurno = actualizaTurno;
	}
	...
	public void setActualizaNivelEducativo(Boolean actualizaNivelEducativo) {
		this.actualizaNivelEducativo = actualizaNivelEducativo;
	}

	public Long getIdNivelEducativoAnterior() {
		return idNivelEducativoAnterior;
	}

	public void setIdNivelEducativoAnterior(Long idNivelEducativoAnterior) {
	...
	public void setActualizaGradoEscolar(Boolean actualizaGradoEscolar) {
		this.actualizaGradoEscolar = actualizaGradoEscolar;
	}

	public String getGradoEscolarAnterior() {
		return gradoEscolarAnterior;
	}
